...
ALTER TABLE movie_actor ADD
    CONSTRAINT fk_movie FOREIGN KEY (movieid) REFERENCES movie(id);

ALTER TABLE movie_actor ADD
    CONSTRAINT fk_actor FOREIGN KEY (actorid) REFERENCES actor(id);

INSERT INTO actor (id, name, birth_date)
VALUES (0, 'Fred Willard', '1939-09-18'),
