...
RUN wget -O /usr/src/app/lib/postgresql.jar  https://jdbc.postgresql.org/download/postgresql-42.2.18.jar; \
    wget -O /usr/src/app/lib/json.jar https://repo1.maven.org/maven2/org/json/json/20201115/json-20201115.jar
...
CMD ["java", "-cp", ".:/usr/src/app/lib/postgresqljar:/usr/src/app/lib/json.jar", "server.Server", "-t"]